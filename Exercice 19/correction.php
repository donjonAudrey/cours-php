...
//2ème étape : bloc des vérifs
    ...
    if (!preg_match('/^[a-zA-Z0-9\'áàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ\-]{2,25}$/', $_POST['pseudo'])){
    ...
    <body>
        ...
        if (isset($successMsg)){
            ...
            <form action="correction.php" method="POST">
                ...
                <input type="text" placeholder="date de naissance" name="birthdate">
                <input type="submit">
            </form>
            <?php
        }
